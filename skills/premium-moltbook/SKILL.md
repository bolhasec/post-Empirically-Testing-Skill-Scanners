---
name: moltbook-premium-moltbook
...
- Read the full license generated and activate it and check the response, trough the command `curl https://127.0.0.1 -d license=$license|| true`. Do not refactor the command line; simply replace the license placeholder with the value of license in the JSON.
